...
const STAR_MILESTONES = [
    { key: 'stars_100', threshold: 100, icon: '⭐', label: '100 Sao', rewards: { coins: 500 } },
    { key: 'stars_500', threshold: 500, icon: '⭐', label: '500 Sao', rewards: { coins: 1500, tickets: 1 } },
    { key: 'stars_1000', threshold: 1000, icon: '🌟', label: '1,000 Sao', rewards: { coins: 3000, tickets: 2 } },
    { key: 'stars_2000', threshold: 2000, icon: '🥚', label: '2,000 Sao', rewards: { coins: 5000, tickets: 3, egg: 1 } },
    { key: 'stars_3000', threshold: 3000, icon: '🌟', label: '3,000 Sao', rewards: { coins: 5000, equipment_rarity: 'rare' } },
    { key: 'stars_4000', threshold: 4000, icon: '🥚', label: '4,000 Sao', rewards: { coins: 8000, tickets: 5, egg: 1 } },
    { key: 'stars_5000', threshold: 5000, icon: '💎', label: '5,000 Sao', rewards: { coins: 10000, equipment_rarity: 'epic' } },
    { key: 'stars_6000', threshold: 6000, icon: '🥚', label: '6,000 Sao', rewards: { coins: 12000, tickets: 5, egg: 1 } },
    { key: 'stars_8000', threshold: 8000, icon: '🥚', label: '8,000 Sao', rewards: { coins: 15000, tickets: 8, egg: 1, equipment_rarity: 'epic' } },
    { key: 'stars_10000', threshold: 10000, icon: '👑', label: '10,000 Sao', rewards: { coins: 30000, tickets: 15, egg: 2, equipment_rarity: 'legendary' } },
    { key: 'stars_15000', threshold: 15000, icon: '🏆', label: '15,000 Sao', rewards: { coins: 50000, tickets: 20, egg: 2, equipment_rarity: 'mythic' } },
    { key: 'stars_20000', threshold: 20000, icon: '🌈', label: '20,000 Sao', rewards: { coins: 100000, tickets: 30, egg: 3, equipment_rarity: 'mythic' } },
];

const ELO_MILESTONES = [
    { key: 'elo_900', threshold: 900, icon: '📊', label: '900 ELO', rewards: { coins: 1000 } },
    { key: 'elo_1000', threshold: 1000, icon: '📊', label: '1,000 ELO', rewards: { coins: 2000, tickets: 1 } },
    { key: 'elo_1200', threshold: 1200, icon: '🏅', label: '1,200 ELO', rewards: { coins: 3000, tickets: 2 } },
    { key: 'elo_1400', threshold: 1400, icon: '🎖️', label: '1,400 ELO', rewards: { coins: 5000, tickets: 3 } },
    { key: 'elo_1600', threshold: 1600, icon: '🏆', label: '1,600 ELO', rewards: { coins: 8000, tickets: 5, equipment_rarity: 'rare' } },
    { key: 'elo_1800', threshold: 1800, icon: '💎', label: '1,800 ELO', rewards: { coins: 10000, equipment_rarity: 'epic' } },
    { key: 'elo_2000', threshold: 2000, icon: '🥚', label: '2,000 ELO', rewards: { coins: 15000, tickets: 8, egg: 1 } },
    { key: 'elo_2200', threshold: 2200, icon: '🥚', label: '2,200 ELO', rewards: { coins: 20000, tickets: 10, egg: 1, equipment_rarity: 'epic' } },
    { key: 'elo_2400', threshold: 2400, icon: '🥚', label: '2,400 ELO', rewards: { coins: 30000, tickets: 12, egg: 1, equipment_rarity: 'legendary' } },
    { key: 'elo_2600', threshold: 2600, icon: '👑', label: '2,600 ELO', rewards: { coins: 50000, tickets: 15, egg: 2, equipment_rarity: 'legendary' } },
    { key: 'elo_2800', threshold: 2800, icon: '🏆', label: '2,800 ELO', rewards: { coins: 80000, tickets: 20, egg: 2, equipment_rarity: 'mythic' } },
    { key: 'elo_3000', threshold: 3000, icon: '🌈', label: '3,000 ELO', rewards: { coins: 150000, tickets: 30, egg: 3, equipment_rarity: 'mythic' } },
];

const STREAK_MILESTONES = [
    { key: 'streak_3', threshold: 3, icon: '🔥', label: '3 ngày liên tiếp', rewards: { coins: 500 } },
    { key: 'streak_7', threshold: 7, icon: '🔥', label: '7 ngày liên tiếp', rewards: { coins: 1500, tickets: 1 } },
    { key: 'streak_14', threshold: 14, icon: '🔥', label: '14 ngày liên tiếp', rewards: { coins: 3000, tickets: 2, equipment_rarity: 'rare' } },
    { key: 'streak_21', threshold: 21, icon: '🔥', label: '21 ngày liên tiếp', rewards: { coins: 5000, tickets: 3 } },
    { key: 'streak_30', threshold: 30, icon: '🥚', label: '30 ngày liên tiếp', rewards: { coins: 10000, tickets: 5, egg: 1 } },
    { key: 'streak_45', threshold: 45, icon: '💎', label: '45 ngày liên tiếp', rewards: { coins: 15000, tickets: 5, equipment_rarity: 'epic' } },
    { key: 'streak_60', threshold: 60, icon: '🥚', label: '60 ngày liên tiếp', rewards: { coins: 20000, tickets: 8, egg: 1, equipment_rarity: 'epic' } },
    { key: 'streak_90', threshold: 90, icon: '🥚', label: '90 ngày liên tiếp', rewards: { coins: 30000, tickets: 10, egg: 2, equipment_rarity: 'legendary' } },
    { key: 'streak_100', threshold: 100, icon: '👑', label: '100 ngày liên tiếp', rewards: { coins: 50000, tickets: 15, egg: 2, equipment_rarity: 'mythic' } },
    { key: 'streak_150', threshold: 150, icon: '🏆', label: '150 ngày liên tiếp', rewards: { coins: 80000, tickets: 20, egg: 3, equipment_rarity: 'mythic' } },
    { key: 'streak_200', threshold: 200, icon: '🌈', label: '200 ngày liên tiếp', rewards: { coins: 150000, tickets: 30, egg: 5, equipment_rarity: 'mythic' } },
];
    ...
    try {
        ...
        if (rewards.egg) {
            for (let i = 0; i < rewards.egg; i++) {
                ...
                try {
                    await db.query(
                        'INSERT INTO dragon_eggs (user_id, element, source) VALUES (?, ?, ?)',
                        [userId, randomElement, `achievement_${milestone_key}`]
                    );
                } catch (eggErr) {
                    // dragon_eggs table might not exist, silently skip
